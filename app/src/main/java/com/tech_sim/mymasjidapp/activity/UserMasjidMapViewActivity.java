...
public class UserMasjidMapViewActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        masjiidmodels= PreferenceManager.userMasjidmodels;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        int count= PreferenceManager.userMasjidmodels.size();
        for(int i=0;i<count;i++) {
            float latitude =Float.parseFloat( PreferenceManager.userMasjidmodels.get(i).getLatitude());
            float longitude = Float.parseFloat( PreferenceManager.userMasjidmodels.get(i).getLongitude());
            String name= PreferenceManager.userMasjidmodels.get(i).getName();
