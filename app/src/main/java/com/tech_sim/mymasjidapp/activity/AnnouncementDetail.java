...
public class AnnouncementDetail extends AppCompatActivity {
    ...
    public void startPlay(){
        try {
            ...
            chronometer.start();
            Toast.makeText(AnnouncementDetail.this,"Start playing...",Toast.LENGTH_SHORT).show();
    ...
    public void stopPlay(){
        try {
            ...
            mediaPlayer.release();
            chronometer.stop();
            Toast.makeText(AnnouncementDetail.this, "Stop playing...", Toast.LENGTH_SHORT).show();
        }
        catch (Exception e)
        {
            e.printStackTrace();
