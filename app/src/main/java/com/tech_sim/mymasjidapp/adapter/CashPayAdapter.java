...
public class CashPayAdapter extends RecyclerView.Adapter<CashPayAdapter.ViewHolder> {

    private ArrayList<UserPayModel> userPayModels;
    private LayoutInflater layoutInflater;
    private Context context;
    public CashPayAdapter(Context context,ArrayList<UserPayModel> userPayModels)
    {
    ...
    @NonNull
    @Override
    public CashPayAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view=layoutInflater.inflate(R.layout.item_child_pay,viewGroup,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CashPayAdapter.ViewHolder viewHolder, int i) {
